...
CREATE TABLE IF NOT EXISTS vest (
  ...
  to_uid INT(11) REFERENCES users(id) NOT NULL DEFAULT 0,
  ...
  to_guid INT(11) REFERENCES groups(id) NOT NULL DEFAULT 0,
  ...
  subject_vest_id INT(12) NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS vest_subject_vest_id ON vest(subject_vest_id);
